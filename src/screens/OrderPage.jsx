...
export default function OrderPage() {
    ...
    const handleOrder = async () => {
        ...
        try {
            ...
            const res = await Axios.post("https://api-ban-hang.herokuapp.com/order", orderData, {
                headers: {
        ...
        <div className="Order">
            ...
            <div className="Order__content">
                <div className="container">
                            ...
                            <div className="Order__pay">
                                ...
                                <div className="Order__pay__content">
                                    ...
                                    <div className="Order__pay__content__box">
                                        ...
                                        vấn viên của Luxury Shopping sẽ chủ động liên hệ để hướng
                                        dẫn cụ thể cho Quý khách hàng.
                  </div>
                                    <div className="Order__pay__content__title">
                    ...
                    <br />
                    Quý khách nhận hàng, kiểm tra và thanh toán thông qua các
                    đối tác vận chuyển của Luxury Shopping.
                  </div>
                                </div>
                            </div>
                        </div>
